...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2 col-xs-12">
            ...
            <img class="featured-image img-fluid" src="{{asset('/')}}website/img/demopic/10.jpg" alt="">
            <!-- End Featured Image -->
            ...
            <div class="article-post">
                <p>
                    ...
                    iteration assets website business plan paradigm shift stealth mass market seed money rockstar niche market
                ...
                <blockquote>
                    ...
                    network low hanging fruit direct mailing. Client backing success startup assets website responsive web
    ...
    <div class="container">
        <div class="row listrecent listrelated">
            ...
            <div class="col-md-4">
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid img-thumb" src="{{asset('/')}}website/img/demopic/9.jpg" alt="">
                    </a>
            ...
            <div class="col-md-4">
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid img-thumb" src="{{asset('/')}}website/img/demopic/8.jpg" alt="">
                    </a>
                    <div class="card-block">
            ...
            <div class="col-md-4">
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid img-thumb" src="{{asset('/')}}website/img/demopic/7.jpg" alt="">
                    </a>
                    <div class="card-block">
...
<div class="alertbar">
    <div class="container text-center">
        <img src="{{asset('/')}}website/img/logo.png" alt=""> &nbsp; Never miss a <b>story</b> from us, get weekly updates in your
...
<script src="{{asset('/')}}website/js/mediumish.js"></script>
</body>
</html>

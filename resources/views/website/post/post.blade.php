...
================================================== -->
            ...
            <div class="col-md-8 col-md-offset-2 col-xs-12">
                <div class="mainheading">
                    ...
                    <div class="row post-top-meta">
                        ...
                        <div class="col-md-10">
                            <a class="link-dark" href="author.html">{{Auth::user()->name}}</a><a href="#" class="btn follow">Follow</a>
                            ...
                            <span class="post-date">{{$blog->created_at}}</span><span class="dot"></span><span class="post-read">6 min read</span>
                        </div>
                    </div>
                    <!-- End Top Menta -->

                    <h1 class="posttitle">{{$blog->main_title}}</h1>
                ...
                @foreach($blogs as $blog)
                    ...
                    <div class="card">
                        <a href="{{route('post', [$blog->id])}}">
                            <img class="img-fluid img-thumb" src="{{asset($blog->image)}}" alt="">
                        </a>
                        <div class="card-block">
                            <h2 class="card-title"><a href="{{route('post', [$blog->id])}}">{{$blog->main_title}}</a></h2>
                            <div class="metafooter">
								...
								<span class="post-date">{{$blog->created_at}}</span><span class="dot"></span><span
                                            class="post-read">6 min read</span>
								</span>
                                    <span class="post-read-more"><a href="{{route('post', [$blog->id])}}" title="Read Story"><svg
    ...
    <div class="alertbar">
        <div class="container text-center">
            <img src="{{asset('/')}}website/img/logo.png" alt=""> &nbsp; Never miss a <b>story</b> from us, get weekly
            updates in your

    ...
    <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="card-block">
                                <h2 class="card-title"><a href="{{route('post')}}">We're living some strange times</a>
                                </h2>
								...
								<span class="post-date">22 July 2017</span><span class="dot"></span><span
                                        ...
                                        <span class="post-read-more"><a href="{{route('post')}}" title="Read Story"><svg
        ...
        <section class="recent-posts">
            ...
            <div class="card-columns listrecent">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid" src="{{asset('/')}}website/img/demopic/5.jpg" alt="">
                    </a>
                    <div class="card-block">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid" src="{{asset('/')}}website/img/demopic/6.jpg" alt="">
                    </a>
                    <div class="card-block">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid" src="{{asset('/')}}website/img/demopic/7.jpg" alt="">
                    </a>
                    <div class="card-block">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid" src="{{asset('/')}}website/img/demopic/8.jpg" alt="">
                    </a>
                    <div class="card-block">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid" src="{{asset('/')}}website/img/demopic/9.jpg" alt="">
                    </a>
                    <div class="card-block">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid" src="{{asset('/')}}website/img/demopic/10.jpg" alt="">
                    </a>
                    <div class="card-block">
